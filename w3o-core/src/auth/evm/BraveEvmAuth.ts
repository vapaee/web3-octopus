...
const name = 'Brave';
export const BraveEvmAuthName = name;
export class BraveEvmAuth extends InjectedProviderEvmAuth {
    ...
    newInstance(label: string): BraveEvmAuth {
        this.trace('newInstance', label);
        return new BraveEvmAuth(label);
    }
}
